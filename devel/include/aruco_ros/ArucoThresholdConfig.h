...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(ArucoThresholdConfig::AbstractParamDescriptionConstPtr(new ArucoThresholdConfig::ParamDescription<int>("detection_mode", "int", 0, "The detection mode , affects speed and reliability", "{'enum_description': 'detection_mode enum', 'enum': [{'srcline': 12, 'description': '', 'srcfile': '/home/khoixx/dev_ros1_ws/src/aruco_ros/aruco_ros/cfg/ArucoThreshold.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Normal'}, {'srcline': 13, 'description': '', 'srcfile': '/home/khoixx/dev_ros1_ws/src/aruco_ros/aruco_ros/cfg/ArucoThreshold.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Fast'}, {'srcline': 14, 'description': '', 'srcfile': '/home/khoixx/dev_ros1_ws/src/aruco_ros/aruco_ros/cfg/ArucoThreshold.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Video_Fast'}]}", &ArucoThresholdConfig::detection_mode)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 12 "/home/khoixx/dev_ros1_ws/src/aruco_ros/aruco_ros/cfg/ArucoThreshold.cfg"
      const int ArucoThreshold_Normal = 0;
//#line 13 "/home/khoixx/dev_ros1_ws/src/aruco_ros/aruco_ros/cfg/ArucoThreshold.cfg"
      const int ArucoThreshold_Fast = 1;
//#line 14 "/home/khoixx/dev_ros1_ws/src/aruco_ros/aruco_ros/cfg/ArucoThreshold.cfg"
