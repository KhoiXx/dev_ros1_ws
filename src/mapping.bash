...
gnome-terminal --title "ARM" --tab -e 'sh -c "sleep 11; roslaunch robot_bringup arm_control.launch; exec bash"'
...
gnome-terminal --title "RTABMAP" --tab -e 'sh -c "sleep 14; roslaunch robot_bringup robot_rtabmap.launch localization:=false; exec bash"'
