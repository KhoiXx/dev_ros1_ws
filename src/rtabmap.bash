...
gnome-terminal --title "THESIS_ROBOT" --tab -e 'sh -c "sleep 7; roslaunch robot_bringup robot_keyboard.launch; exec bash"'
gnome-terminal --title "CAMERA" --tab -e 'sh -c "sleep 6; roslaunch robot_bringup robot_with_camera.launch; exec bash"'
...
gnome-terminal --title "RTABMAP" --tab -e 'sh -c "sleep 14; roslaunch robot_bringup robot_mapping.launch; exec bash"'
